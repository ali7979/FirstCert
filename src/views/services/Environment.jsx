...
function Environment() {
  ...
  <Row >
    ...
    <Col md="6" >
      {/* Add your image here */}
      <img  src={S14001} alt="Your Image" style={{ maxWidth: "100%",
  height: "auto"}}/>
    </Col>
...
Textile Industry</span></h3>
  ...
  height: "auto"}}/>
    ...
    <Col md="12" className='mb-3 text-center' ><h1 style={{letterSpacing:'2px',wordSpacing:'3px'}}>Requirements for <span style={{color:"#57C5B6",fontWeight:'400'}}>ISO 14001</span></h1></Col> 
